...
class PageGenerator:
    ...
    def calculate_image_dimension(self, text, font_size, font_path):
    ...
    def generate_page_image(self, page_text, font_size, font_path):
        ...
        """
        page_image_dimension = self.calculate_image_dimension(
