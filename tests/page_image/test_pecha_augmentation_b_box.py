...
from SynthImage.DataGeneration.pecha_format_page_generator import extract_green_contours


def test_extract_green_contours():
    # Load the image from the specified path
    image_path = "tests/data/pecha_format_page_img/test_image_with_bbox.png"
